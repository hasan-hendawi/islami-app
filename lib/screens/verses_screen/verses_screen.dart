...
class _VersesScreenState extends State<VersesScreen> {
                  ...
                  child: Padding(
                    ...
                    child:ayaVerse.isEmpty?
                      ...
                      separatorBuilder: (context,i){
                        return Divider(thickness: 2,color:Theme.of(context).primaryColor,indent: 14, endIndent: 14,height: 20,);
  ...
  void readFile(int verseIndex) async {
   ...
   String verse=await rootBundle.loadString("assets/verses_content/${verseIndex + 1}.txt");
